...
FILE_NAME = "WannaCrypt.csv" # Ensure this matches your input CSV filename
FEATURE_INDEX = 4  # Column 5 (index 4) = "Number of announcements"
np.set_printoptions(suppress=True, precision=2) 

print(f"--- Running Dual Replication: WannaCrypt Incident ---")
...
# --- 2. ANALYSIS 1: m=2880 (Figura 12) ---
print("\n--- ANALYSIS 1 (m=2880) ---")
WINDOW_SIZE_1 = 2880
K_DISCORDS_1 = 2 # k=2 for Top-k discord analysis
...
print("Validation: The paper (Fig. 12) reports peaks at ~3860 and ~6850 min.")


# --- 3. ANALYSIS 2: m=1440 (Alarma Temprana) ---
print("\n--- ANALYSIS 2 (m=1440) ---")
WINDOW_SIZE_2 = 1440
K_DISCORDS_2 = 2 # k=2 to search for the early alarm
...
print("\nValidation: The paper reports an early alarm (k2) at ~2050 min.")


# --- 4. VISUALIZATION ---

# Plot 1 (m=2880) - Comparison with Figure 12
plt.figure(1, figsize=(18, 10))
plt.suptitle(f'WannaCrypt: Analysis m={WINDOW_SIZE_1} (Comparison Fig. 12)', fontsize=16)
...
# Plot 2 (m=1440) - Alarma Temprana
plt.figure(2, figsize=(18, 10))
plt.suptitle(f'WannaCrypt: Analysis m={WINDOW_SIZE_2} (Early Alarm)', fontsize=16)
