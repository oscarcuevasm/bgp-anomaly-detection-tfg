...
OUTPUT_DIR = "./PMP_Resultados_CodeRed" # Carpeta donde se guardarán los PNGs
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE CODERED (12 JULIO 2001) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 12 Jul 2001 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_12jul_{column_name}.png")
