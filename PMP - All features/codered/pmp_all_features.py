...
OUTPUT_DIR = "./PMP_Resultados_CodeRed" # Directory where PNGs will be saved
...
print(f"--- STARTING MULTI-COLUMN PMP: CODE RED BASELINE (12 JULY 2001) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'BGP Volume ({column_name}) - 12 Jul 2001', fontweight='bold')
