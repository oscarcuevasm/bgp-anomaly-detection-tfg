...
OUTPUT_DIR = "./PMP_Resultados_Moscow" # Directory where PNGs will be saved
...
print(f"--- STARTING MULTI-COLUMN PMP: MOSCOW BLACKOUT BASELINE (25 MAY 2005) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'BGP Volume ({column_name}) - 25 May 2005', fontweight='bold')
