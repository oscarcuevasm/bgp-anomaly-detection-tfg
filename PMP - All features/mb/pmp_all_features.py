...
# --- 1. CONFIGURACIÓN ---
FILE_BASELINE = "./Moscow_Blackout_RRC04_Raw/moscow_blackout_25may_features_1s.csv"
OUTPUT_DIR = "./PMP_Resultados_Moscow" # Carpeta donde se guardarán los PNGs
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE MOSCOW BLACKOUT (25 MAYO 2005) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 25 May 2005 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_25may_{column_name}.png")
