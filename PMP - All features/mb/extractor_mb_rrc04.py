...
# --- PATH CONFIGURATION ---
BASE_URL = "https://data.ris.ripe.net/rrc04/2005.05"
RIPE_DIR = "./Moscow_Blackout_RRC04_Raw"
...
PERIODS = [
    ("20050518.0000", "20050518.2355", os.path.join(RIPE_DIR, "moscow_baseline_18may_raw.csv")),
    ("20050525.0000", "20050525.2355", os.path.join(RIPE_DIR, "moscow_blackout_25may_raw.csv"))
]
