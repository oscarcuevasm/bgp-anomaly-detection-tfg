...
BASE_URL = "https://data.ris.ripe.net/rrc04/2015.06"
RIPE_DIR = "./Telekom_Malaysia_RRC04_Raw"
...
PERIODS = [
    ("20150612.0000", "20150612.2355", os.path.join(RIPE_DIR, "telekom_malaysia_12jun_raw.csv")),
    ("20150605.0000", "20150605.2355", os.path.join(RIPE_DIR, "telekom_malaysia_baseline_5jun_raw.csv"))
]
