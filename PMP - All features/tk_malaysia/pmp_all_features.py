...
# --- 1. CONFIGURACIÓN ---
FILE_BASELINE = "./Telekom_Malaysia_RRC04_Raw/telekom_malaysia_12jun_features_1s.csv"
OUTPUT_DIR = "./PMP_Resultados_Telekom_Malaysia" # Carpeta donde se guardarán los PNGs
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE TELEKOM MALAYSIA (12 JUNIO 2015) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 12 Junio 2015 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_12jun_{column_name}.png")
