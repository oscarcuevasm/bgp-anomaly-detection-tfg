...
OUTPUT_DIR = "./PMP_Resultados_Telekom_Malaysia" # Directory where PNGs will be saved
...
print(f"--- STARTING MULTI-COLUMN PMP: TELEKOM MALAYSIA BASELINE (12 JUNE 2015) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'BGP Volume ({column_name}) - 12 June 2015', fontweight='bold')
