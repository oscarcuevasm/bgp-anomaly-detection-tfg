...
PERIODS = [
    ("20170515.0000", "20170515.2355", os.path.join(RIPE_DIR, "wannacrypt_15may_raw.csv")),
    ("20170508.0000", "20170508.2355", os.path.join(RIPE_DIR, "wannacrypt_baseline_8may_raw.csv"))
]
