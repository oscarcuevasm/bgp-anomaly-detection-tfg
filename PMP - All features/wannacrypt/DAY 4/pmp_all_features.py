...
# --- 1. CONFIGURACIÓN ---
FILE_BASELINE = "./Wannacrypt_RRC04_Raw/wannacrypt_anomaly_15may_features_1s.csv"
...
print(f"--- INICIANDO PMP MULTICOLUMNA: ANOMALÍA WANNACRYPT (15 MAYO 2017) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 15 May 2017 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_15may_{column_name}.png")
