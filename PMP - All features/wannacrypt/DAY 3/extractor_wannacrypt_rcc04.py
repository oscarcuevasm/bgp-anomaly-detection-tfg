...
PERIODS = [
    ("20170514.0000", "20170514.2355", os.path.join(RIPE_DIR, "wannacrypt_14may_raw.csv")),
    ("20170507.0000", "20170507.2355", os.path.join(RIPE_DIR, "wannacrypt_baseline_7may_raw.csv"))
]
