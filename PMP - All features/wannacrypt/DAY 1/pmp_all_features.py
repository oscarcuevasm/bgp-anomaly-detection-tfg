...
# --- 1. CONFIGURACIÓN ---
FILE_BASELINE = "./Wannacrypt_RRC04_Raw/wannacrypt_anomaly_12may_features_1s.csv"
OUTPUT_DIR = "./PMP_Resultados_Wannacrypt" # Carpeta donde se guardarán los PNGs
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE WANNACRYPT (12 MAYO 2017) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 12 May 2017 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_12may_{column_name}.png")
