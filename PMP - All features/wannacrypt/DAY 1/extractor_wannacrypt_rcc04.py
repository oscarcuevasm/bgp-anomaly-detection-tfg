...
PERIODS = [
    ("20170512.0000", "20170512.2355", os.path.join(RIPE_DIR, "wannacrypt_12may_raw.csv")),
    ("20170505.0000", "20170505.2355", os.path.join(RIPE_DIR, "wannacrypt_baseline_5may_raw.csv"))
]
