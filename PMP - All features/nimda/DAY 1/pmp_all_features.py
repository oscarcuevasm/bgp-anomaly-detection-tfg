...
# --- 1. CONFIGURATION ---
FILE_BASELINE = "./Nimda_RRC04_Raw/nimda_baseline_11sept_features_1s.csv"
...
print(f"--- INICIANDO PMP MULTICOLUMNA: ANOMALÍA NIMDA (11 SEPTIEMBRE 2001) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 11 Septiembre 2001 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_11sept_{column_name}.png")
