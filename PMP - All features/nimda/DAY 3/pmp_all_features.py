...
# --- 1. CONFIGURATION ---
FILE_BASELINE = "./Nimda_RRC04_Raw/nimda_baseline_13sept_features_1s.csv"
OUTPUT_DIR = "./PMP_Resultados_Nimda" # Directory where PNGs will be saved
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE NIMDA (13 SEPTIEMBRE 2001) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 13 Septiembre 2001 ', fontweight='bold')
    ...
    output_filename = os.path.join(OUTPUT_DIR, f"pmp_13sept_{column_name}.png")
