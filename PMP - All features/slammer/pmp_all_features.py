...
OUTPUT_DIR = "./PMP_Resultados_Slammer" # Carpeta donde se guardarán los PNGs
...
print(f"--- INICIANDO PMP MULTICOLUMNA: LÍNEA BASE SLAMMER (11 ENE 2003) ---")
...
for idx_col, column_name in enumerate(COLUMNS_TO_ANALYZE, 1):
    ...
    ax1.set_title(f'Volumen BGP ({column_name}) - 11 Ene 2003 ', fontweight='bold')
